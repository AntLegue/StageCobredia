...
if ( $_COOKIE['CAPVO_WIDTH'] <= 400 )
	{
	?>
		<div id="photos" style="max-height:680px;background-color:white;display: none;position: absolute;top: 5px;z-index: 99;overflow-y:scroll;box-shadow: 8px 8px 12px #aaa;border: solid #3D3232 1px; width: 360px;">
			<a href='#' class="Position" onclick="showPhotos(1);location.reload();" style="color:black;font-size:18px;text-decoration:none;color:black;font-size:18px;width:18px;border: solid #333333">
				<b>X</b>
			</a>		
    		<table width="880px" height="680px"">
	<?php
	}
else
	{
	?>
		<div id="photos" style="max-height:680px;background-color:white;display: none;position: absolute;top: 5px;z-index: 99;overflow-y:scroll;box-shadow: 8px 8px 12px #aaa;border: solid #3D3232 1px; width: 360px;">
			...
			<table width="320px" height="680px"">
	<?php
	}
				...
				if ( file_exists ( $dirdoc.$vehicule_id."/{$entry}.jpgl" ) )
					{
						?>
							<tr align='center'>
    							<td>
									<img class="zoomD" src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>.jpgl" style="max-width: 100%; max-height:auto;float:left;" loading="lazy"></img>
								</td>  
					...
					?>
						<tr align='center'>
    						<td>
								<img class="zoomD" src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>" style="max-width: 100%; max-height:auto;float:left;" loading="lazy"></img>
							</td>
						</tr>
					<?php
					}	
				...
				if ( $_COOKIE['CAPVO_WIDTH'] <= 400 )
					{
						?>
							<tr align='center'>
								<td>
									<embed src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>" style="max-width:310px;float:left;" type="application/pdf">
								</td>
							</tr>
						<?php
					}
				else
					{
						?>
							<tr align='center'>
								<td>
									<embed src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>" width='840px' height='520px' style="max-width:310px;float:left;" type="application/pdf">
								</td>
							</tr>
						<?php
					}
