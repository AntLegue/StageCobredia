...
<link rel="stylesheet" type="text/css" href="style_al.css">
...
$(document).ready(function()
	...
	function afficheImage(valeurImage, environnement){
		...
		const listeTest = document.querySelectorAll("div.Previsualisation");
		//parcours tous les elements de la liste en recuperant les id pour masquer les images
		Array.from(listeTest).forEach(element => {
...
<tr><td height='45'>Photo Avant : </td><td align='center'><label for=\"photo_avant\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'> </label><input type=\"file\" id=\"photo_avant\"  class=\"input-file\" accept='image/*'  style=\"display:none\" name=\"photo_avant\" /></td></tr>
