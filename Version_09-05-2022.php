...
if ( $_COOKIE['CAPVO_WIDTH'] <= 400 )
	{
	?>
		<div id="photos" style="background-color:white;display: none;position: absolute;left: 345px;top: 30px;z-index: 99;overflow-y:scroll;height:680px;box-shadow: 8px 8px 12px #aaa;border: solid #3D3232 1px;">
			<a href='#' class="Position" onclick="showPhotos(1);location.reload();" style="color:black;font-size:18px;text-decoration:none;color:black;font-size:18px">
				<b>X</b>
			</a>		
	...
	?>
		<div id="photos" style="background-color:white;display: none;position: absolute;left: 345px;top: 30px;z-index: 99;overflow-y:scroll;height:680px;box-shadow: 8px 8px 12px #aaa;border: solid #3D3232 1px;">
			<a href='#' class="Position" onclick="showPhotos(1);location.reload();" style="color:black;font-size:18px;text-decoration:none;color:black;font-size:18px;width:25px">
				<b>X</b>
			</a>
			<table width="880px" height="680px"">
	<?php
