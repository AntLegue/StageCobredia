...
$(document).ready(function()
	...
	function replay_photo(event){
		...
		var isEmpty = $("#button_id").html() === "";
		console.log(isEmpty);
		
		
		//vérifie si la div est affichée
		if(div_image.css('display') == 'none'){
			...
			$("tr.block_photo_" + button_id + " button.BoutonPhoto").html('Afficher Photo ' + button_id);
		};
	};
...
<tr class="block-image-field block_photo_<?= $id ?>">
	<td colspan="2" >
		<div class="Previsualisation"></div>
	</td>
</tr>
<tr class="block-image-field block_photo_<?= $id ?>">
	<td colspan="2" >
