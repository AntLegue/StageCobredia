...
<div style="overflow:scroll" id="lightbox"></div>
...
if ( $_COOKIE['CAPVO_WIDTH'] <= 400 )
	...
	?>
		<div id="photos" style="max-height:680px;background-color:white;display: none;position: absolute;top: 5px;z-index: 99;overflow-y:scroll;box-shadow: 8px 8px 12px #aaa;border: solid #3D3232 1px; width: 360px;">
			<a href='#' class="Position" onclick="showPhotos(1);location.reload();" style="color:black;font-size:18px;text-decoration:none;color:black;font-size:18px;width:17px">
				<b>X</b>
			</a>		
