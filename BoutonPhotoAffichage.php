...
$(document).ready(function()
			...
			if (input.files) 
			{
				...
				for (i = 0; i < filesAmount; i++) 
					...
					reader.onload = function(event)
							{
							data = reader.result;
							sendData(data, 'https://app.cobredia.bzh:11443/dcapvo/webapp/save-img.php',nom,cotid,fic_type);
	...
	function CacheBouton(){
		//recupere tout les boutons de la class BoutonDivers et les places dans une liste
		const listeBoutonDivers = document.querySelectorAll('.BoutonDivers');
		//recupere tout les boutons de la class BoutonFermer et les places dans une liste
		const listeBoutonFermer = document.querySelectorAll('.BoutonFermer');
		//permet de récuperer l'id du bouton affichage divers à cacher
		const ListeBoutonShowDivers = document.querySelectorAll('.BoutonDivers');
		//parcours tous les elements de la liste en recuperant les id pour masquer les images
		Array.from(listeBoutonDivers).forEach(element => {
			//cache les boutons
			element.style.display  = 'none';
		});
		//parcours tous les elements de la liste en recuperant les id pour masquer les boutons fermer
		Array.from(listeBoutonFermer).forEach(element => {
			//cache les boutons
			element.style.display  = 'none';
		});		
		//parcours tous les elements de la liste en recuperant les boutons  pour afficher 
		Array.from(ListeBoutonShowDivers).forEach(element => {
			element.style.display = 'none';
		});
	}
	
	//Utilise la fonction pour cacher les boutons de la catégorie divers qui ne sont pas forcement utilise
	window.onload = CacheBouton();
	
	//Fonction pour afficher le bouton fermer lors du chargement de la photo
	function showCloseButton(valeurBouton){	
		//permet de récuperer l'id du bouton fermer à afficher
		var BoutonShow = document.querySelectorAll('.BoutonPhoto')[valeurBouton].id;
		//bouton fermer a afficher lorsque l'image est chargé
		document.getElementById(BoutonShow).style.display = 'none';
		//permet de récuperer l'id du bouton fermer à afficher
		var BoutonClose = document.querySelectorAll('.BoutonFermer')[valeurBouton].id;
		//bouton fermer a afficher lorsque l'image est chargé
		document.getElementById(BoutonClose).style.display = 'block';
	}
	
	//fonction d'affichage des images et camoufles celle déjà affichée
	function afficheImage(valeurImage, environnement){
		//permet de récuperer l'id de la photo à charger 
		var AffichagePresent = document.querySelectorAll('div.Previsualisation')[valeurImage].id
		//récupere toutes les divs comprenant la class Previsualisation
		const listeDivPhoto = document.querySelectorAll('div.Previsualisation');
		//parcours tous les elements de la liste en recuperant les id pour masquer les images
		Array.from(listeDivPhoto).forEach(element => {
			element.style.display = 'none';
		});
		//affiche bouton fermer et cache bouton affichage photo
		showCloseButton(valeurImage);
		//affiche la div pour l'image a chargé
		document.getElementById(AffichagePresent).style.display = 'block';
		//affichel'image
		imagesPreview(environnement, 'div.' + AffichagePresent, AffichagePresent.slice(11),AffichagePresent);
	};
	

    $('#photo_avant').on('change', function() {
    	$(".prev_photo_avant").html("");
		afficheImage(0, this);
    });
	
	$('#photo_droite').on('change', function() {
    	$(".prev_photo_droite").html("");
		afficheImage(1, this);
    });
	
	$('#photo_arriere').on('change', function() {
    	$(".prev_photo_arriere").html("");
		afficheImage(2, this);
	}); 
	
    $('#photo_gauche').on('change', function() {
    	$(".prev_photo_gauche").html("");
		afficheImage(3, this);
	});
	
    $('#photo_int1').on('change', function() {
    	$(".prev_photo_int1").html("");
		afficheImage(4, this);
    });
	
	$('#photo_int2').on('change', function() {
    	$(".prev_photo_int2").html("");
		afficheImage(5, this);	
	});
	
	$('#photo_cg').on('change', function() {
    	$(".prev_photo_cg").html("");
		afficheImage(6, this);	
	});				
    
	$('#photo_ct').on('change', function() {
    	$(".prev_photo_ct").html("");
		afficheImage(7, this);	
	 });

	$('#photo_rep').on('change', function() {
    	$(".prev_photo_rep").html("");	
		afficheImage(8, this);	
	});	
    
	$('#photo_car1').on('change', function() {
    	$(".prev_photo_car1").html("");
		afficheImage(9, this);	
		
		//cela affiche le label suivant ainsi que le bouton associé
		document.getElementById('prev_photo_car2').style.display = 'block';
		document.getElementById('file_car2').style.display = 'block';
		document.getElementById('ph_car2').style.display = 'block';
		document.getElementById('PhotoDivers2').style.display = 'block';
    });
	$('#photo_car2').on('change', function() {
    	$(".prev_photo_car2").html("");
		afficheImage(10, this);
		
		document.getElementById('prev_photo_car3').style.display = 'block';
		document.getElementById('file_car3').style.display = 'block';
		document.getElementById('ph_car3').style.display = 'block';
		document.getElementById('PhotoDivers3').style.display = 'block';
		
    });
	
	$('#photo_car3').on('change', function() {
		$(".prev_photo_car3").html("");
		afficheImage(11, this);
		
		document.getElementById('prev_photo_car4').style.display = 'block';
		document.getElementById('file_car4').style.display = 'block';
		document.getElementById('ph_car4').style.display = 'block';
		document.getElementById('PhotoDivers4').style.display = 'block';
    });
	
	$('#photo_car4').on('change', function() {
    	$(".prev_photo_car4").html("");
		afficheImage(12, this);
		
		document.getElementById('prev_photo_car5').style.display = 'block';
		document.getElementById('file_car5').style.display = 'block';
		document.getElementById('ph_car5').style.display = 'block';
		document.getElementById('PhotoDivers5').style.display = 'block';
    });
	
	$('#photo_car5').on('change', function() {
    	$(".prev_photo_car5").html("");		
		afficheImage(13, this);

		document.getElementById('prev_photo_car6').style.display = 'block';
		document.getElementById('file_car6').style.display = 'block';
		document.getElementById('ph_car6').style.display = 'block';
		document.getElementById('PhotoDivers6').style.display = 'block';
    });
	
	$('#photo_car6').on('change', function() {
    	$(".prev_photo_car6").html("");		
		afficheImage(14, this);
		
		document.getElementById('prev_photo_car7').style.display = 'block';
		document.getElementById('file_car7').style.display = 'block';
		document.getElementById('ph_car7').style.display = 'block';
		document.getElementById('PhotoDivers7').style.display = 'block';
    });
	
	$('#photo_car7').on('change', function() {
    	$(".prev_photo_car7").html("");		
		afficheImage(15, this);
		
		document.getElementById('prev_photo_car8').style.display = 'block';
		document.getElementById('file_car8').style.display = 'block';
		document.getElementById('ph_car8').style.display = 'block';
		document.getElementById('PhotoDivers8').style.display = 'block';
    });
	
	$('#photo_car8').on('change', function() {
    	$(".prev_photo_car8").html("");		
		afficheImage(16, this);
		
		document.getElementById('prev_photo_car9').style.display = 'block';
		document.getElementById('file_car9').style.display = 'block';
		document.getElementById('ph_car9').style.display = 'block';
		document.getElementById('PhotoDivers9').style.display = 'block';
    });
	
	$('#photo_car9').on('change', function() {
    	$(".prev_photo_car9").html("");
		afficheImage(17, this);
		
		document.getElementById('prev_photo_car10').style.display = 'block';
		document.getElementById('file_car10').style.display = 'block';
		document.getElementById('ph_car10').style.display = 'block';
		document.getElementById('PhotoDivers10').style.display = 'block';
    });
	
	$('#photo_car10').on('change', function() {
    	$(".prev_photo_car10").html("");
		afficheImage(18, this);
    });
})

function ReaffichePhoto(DivChoisi){
	//permet de récuperer l'id de la photo à charger 
	var Reaffiche = document.querySelectorAll("div.Previsualisation")[DivChoisi].id;
	//permet de récuperer l'id du bouton fermer à afficher
	var BoutonClose = document.querySelectorAll(".BoutonFermer")[DivChoisi].id;
	//permet de récuperer l'id du bouton afficher à afficher
	var BoutonAffiche = document.querySelectorAll(".BoutonPhoto")[DivChoisi].id;
	//permet de récuperer la div où se situe la photo à charger 
	var ReafficheDiv = document.querySelectorAll("div.Previsualisation")[DivChoisi];
	//verifie si la div est null, si c'est le cas cela affiche la div sinon cela cache la div
	if(ReafficheDiv.style.display == 'none'){
		//affiche la photo
		document.getElementById(Reaffiche).style.display = 'block';
		//Affiche le bouton fermer 
		document.getElementById(BoutonClose).style.display = 'block';
		//cache le bouton fermer
		document.getElementById(BoutonAffiche).style.display = 'none';
	} else {
		//cache la photo
		document.getElementById(Reaffiche).style.display = 'none';
		//cache le bouton fermer
		document.getElementById(BoutonClose).style.display = 'none';
		//affiche le bouton affiche
		document.getElementById(BoutonAffiche).style.display = 'block';
	};
};
...
<tr><td height='45'>Photo Avant : </td><td align='center'><label for=\"photo_avant\" class=\"label-file\" id='test'>&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' id='test1' height='40px'> </label><input type=\"file\" id=\"photo_avant\"  class=\"input-file\" accept='image/*'  style=\"display:none\" name=\"photo_avant\" /></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='avant'></div> </td></tr>
<tr><td colspan='2' ><div class='prev_photo_avant Previsualisation'  id='prev_photo_avant' ></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoAvant' onClick = ReaffichePhoto(0)>Afficher Photo Avant</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoAvantFermer' onClick = ReaffichePhoto(0)>Fermer la photo</button></td></tr>
 
<tr><td height='45'>Photo Droite : </td><td align='center'><label for=\"photo_droite\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' accept='image/*' id='photo_droite' class=\"input-file\" style=\"display:none\" name='photo_droite' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='droite'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_droite Previsualisation' id='prev_photo_droite' ></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoDroite' onClick = ReaffichePhoto(1)>Afficher Photo Droite</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoDroiteFermer' onClick = ReaffichePhoto(1)>Fermer la Photo</button></td></tr>
 
<tr><td height='45'>Photo Arriere : </td><td align='center'><label for=\"photo_arriere\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' accept='image/*' id='photo_arriere' class=\"input-file\" style=\"display:none\" name='photo_arriere' ></td></tr> 
<tr><td height='5' colspan='2' align='right'><div id='arriere'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_arriere Previsualisation' id='prev_photo_arriere'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoArriere' onClick = ReaffichePhoto(2)>Afficher Photo Arriere</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoArriereFermer' onClick = ReaffichePhoto(2)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Photo Gauche : </td><td align='center'><label for=\"photo_gauche\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' accept='image/*' id='photo_gauche' class=\"input-file\" style=\"display:none\"  name='photo_gauche' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='gauche'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_gauche Previsualisation' id='prev_photo_gauche'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoGauche' onClick = ReaffichePhoto(3)>Afficher Photo Gauche</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoGaucheFermer' onClick = ReaffichePhoto(3)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Photo Int 1 : </td><td align='center'><label for=\"photo_int1\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' accept='image/*' id='photo_int1' class=\"input-file\" style=\"display:none\"  name='photo_int1' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='int1'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_int1 Previsualisation' id='prev_photo_int1'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoInt1' onClick = ReaffichePhoto(4)>Afficher Photo Int1</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoInt1Fermer' onClick = ReaffichePhoto(4)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Photo Int 2 : </td><td align='center'><label for=\"photo_int2\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' accept='image/*' id='photo_int2' class=\"input-file\" style=\"display:none\"  name='photo_int2' ></td></tr> 
<tr><td height='5' colspan='2' align='right'><div id='int2'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_int2 Previsualisation' id='prev_photo_int2'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoInt2' onClick = ReaffichePhoto(5)>Afficher Photo Int2</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoInt2Fermer' onClick = ReaffichePhoto(5)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Carte Grise : </td><td align='center'><label for=\"photo_cg\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' class=\"input-file\" style=\"display:none\"  accept='image/*' id='photo_cg' name='photo_cg' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='cg'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_cg Previsualisation' id='prev_photo_cg'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoCarteGrise' onClick = ReaffichePhoto(6)>Afficher Photo Carte Grise</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoCarteGriseFermer' onClick = ReaffichePhoto(6)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Cont Tech : </td><td align='center'><label for=\"photo_ct\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' class=\"input-file\" style=\"display:none\"  accept='image/*' id='photo_ct' name='photo_ct' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='ct'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_ct Previsualisation' id='prev_photo_ct'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoContTech' onClick = ReaffichePhoto(7)>Afficher Photo Cont Tech</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoContTechFermer' onClick = ReaffichePhoto(7)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Estimation : </td><td align='center'><label for=\"photo_rep\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' class=\"input-file\" style=\"display:none\"  accept='image/*' id='photo_rep' name='photo_rep' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='rep'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_rep Previsualisation' id='prev_photo_rep'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoEstimation' onClick = ReaffichePhoto(8)>Afficher Photo Estimation</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoEstimationFermer' onClick = ReaffichePhoto(8)>Fermer la Photo</button></td></tr>

<tr><td height='45'>Pb Car/Divers 1 : </td><td align='center'><label for=\"photo_car1\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' accept='image/*' id='photo_car1'  class=\"input-file\" style=\"display:none\"  name='photo_car1' ></td></tr>
<tr><td height='5' colspan='2' align='right'><div id='car1'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car1 Previsualisation' id='prev_photo_car1'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto' id='PhotoDivers1' onClick = ReaffichePhoto(9)>Afficher Photo Divers 1</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer' id='PhotoDivers1Fermer' onClick = ReaffichePhoto(9)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car2' height='45'>Pb Car/Divers 2 : </div></td><td align='center'><div id='file_car2'><label for=\"photo_car2\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label><input type='file' class=\"input-file\" style=\"display:none\"  accept='image/*' id='photo_car2' name='photo_car2' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car2'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car2 Previsualisation' id='prev_photo_car2'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers2' onClick = ReaffichePhoto(10)>Afficher Photo Divers 2</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers2Fermer' onClick = ReaffichePhoto(10)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car3' height='45'>Pb Car/Divers 3 : </div> </td><td align='center'><div id='file_car3'><label for=\"photo_car3\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file' class=\"input-file\" style=\"display:none\"  accept='image/*' id='photo_car3' name='photo_car3' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car3'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car3 Previsualisation' id='prev_photo_car3'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers3' onClick = ReaffichePhoto(11)>Afficher Photo Divers 3</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers3Fermer' onClick = ReaffichePhoto(11)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car4' height='45'>Pb Car/Divers 4 : </div> </td><td align='center'><div id='file_car4'><label for=\"photo_car4\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file' class=\"input-file\" style=\"display:none\"  accept='image/*' id='photo_car4' name='photo_car4' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car4'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car4 Previsualisation' id='prev_photo_car4'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers4' onClick = ReaffichePhoto(12)>Afficher Photo Divers 4</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers4Fermer' onClick = ReaffichePhoto(12)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car5' height='45'>Pb Car/Divers 5 : </div> </td><td align='center'><div id='file_car5'><label for=\"photo_car5\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file'  class=\"input-file\" style=\"display:none\" accept='image/*' id='photo_car5' name='photo_car5' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car5'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car5 Previsualisation' id='prev_photo_car5'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers5' onClick = ReaffichePhoto(13)>Afficher Photo Divers 5</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers5Fermer' onClick = ReaffichePhoto(13)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car6' height='45'>Pb Car/Divers 6 : </div> </td><td align='center'><div id='file_car6'><label for=\"photo_car6\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file'  class=\"input-file\" style=\"display:none\" accept='image/*' id='photo_car6' name='photo_car6' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car6'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car6 Previsualisation' id='prev_photo_car6'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers6' onClick = ReaffichePhoto(14)>Afficher Photo Divers 6</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers6Fermer' onClick = ReaffichePhoto(14)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car7' height='45'>Pb Car/Divers 7 : </div> </td><td align='center'><div id='file_car7'><label for=\"photo_car7\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file'  class=\"input-file\" style=\"display:none\" accept='image/*' id='photo_car7' name='photo_car7' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car7'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car7 Previsualisation' id='prev_photo_car7'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers7' onClick = ReaffichePhoto(15)>Afficher Photo Divers 7</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers7Fermer' onClick = ReaffichePhoto(15)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car8' height='45'>Pb Car/Divers 8 : </div> </td><td align='center'><div id='file_car8'><label for=\"photo_car8\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file'  class=\"input-file\" style=\"display:none\" accept='image/*' id='photo_car8' name='photo_car8' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car8'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car8 Previsualisation' id='prev_photo_car8'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers8' onClick = ReaffichePhoto(16)>Afficher Photo Divers 8</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers8Fermer' onClick = ReaffichePhoto(16)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car9' height='45'>Pb Car/Divers 9 : </div> </td><td align='center'><div id='file_car9'><label for=\"photo_car9\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file'  class=\"input-file\" style=\"display:none\" accept='image/*' id='photo_car9' name='photo_car9' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car9'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car9 Previsualisation' id='prev_photo_car9'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers9' onClick = ReaffichePhoto(17)>Afficher Photo Divers 9</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers9Fermer' onClick = ReaffichePhoto(17)>Fermer la Photo</button></td></tr>

<tr><td ><div id='ph_car10' height='45'>Pb Car/Divers 10 : </div> </td><td align='center'><div id='file_car10'><label for=\"photo_car10\" class=\"label-file\">&nbsp;&nbsp;&nbsp;&nbsp;<img src='/capvo/img/app_photo.png' height='40px'></label> <input type='file'  class=\"input-file\" style=\"display:none\" accept='image/*' id='photo_car10' name='photo_car10' ></div></td></tr>
<tr><td height='0' colspan='2' align='right'><div id='car10'></div> </td></tr>
<tr><td colspan='2'><div class='prev_photo_car10 Previsualisation' id='prev_photo_car10'></div></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonPhoto BoutonDivers' id='PhotoDivers10' onClick = ReaffichePhoto(18)>Afficher Photo Divers 10</button></td></tr>
<tr><td colspan='2' ><button type='button' class='BoutonFermer BoutonDivers' id='PhotoDivers10Fermer' onClick = ReaffichePhoto(18)>Fermer la Photo</button></td></tr>
