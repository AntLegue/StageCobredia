...
if ( $_COOKIE['CAPVO_WIDTH'] <= 400 )
	{
	?>
		<div id="photos" style="background-color:white;display: none;position: fixed;left: 8px;top: 200px;z-index: 99;overflow-y:scroll;height:340px">
    		<table width="321px" height="340px" style="border: solid #3D3232 1px; -moz-box-shadow: 8px 8px 12px #aaa; box-shadow: 8px 8px 12px #aaa; -webkit-box-shadow: 8px 8px 12px #aaa;">
        	<tr>
            	<td width='310'></td>
            	<td width='16'>
					<a href='#' onclick="showPhotos(1);location.reload();" style='color:black;font-size:20px;color:black;font-size:18px'>
						<b>X</b>
					</a>&nbsp;
				</td>
        	</tr>";
	...
	{
	?>
		<div id="photos" style="background-color:white;display: none;position: absolute;left: 345px;top: 30px;z-index: 99;overflow-y:scroll;height:680px">
    		<table width="900px" height="680px" style="border: solid #3D3232 1px; -moz-box-shadow: 8px 8px 12px #aaa; box-shadow: 8px 8px 12px #aaa; -webkit-box-shadow: 8px 8px 12px #aaa;">
        	<tr>
            	<td width='810'></td>
            	<td width='16'></td>
        	</tr>
				...
				if ( file_exists ( $dirdoc.$vehicule_id."/".$entry.".jpgl" ) )
					{
						?>
							<tr align='center'>
    							<td>
									<img src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>.jpgl" style="max-width:96%;margin:1em" loading="lazy"></img>
								</td>
    							<td valign='top'>
									<a href='#' onclick="showPhotos(1);location.reload();" style='color:black;font-size:18px;text-decoration:none;color:black;font-size:18px'>
										<b>X</b>
									</a>
								</td>
							</tr>
					...
					?>
						<tr align='center'>
    						<td>
								<img src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>" style="max-width:96%;margin:1em" loading="lazy"></img>
							</td>
						</tr>
					<?php
					}	
				...
				if ( $_COOKIE['CAPVO_WIDTH'] <= 400 )
					{
						?>
							<tr align='center'>
								<td>
									<embed src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>" style="max-width:810px;margin:1em" type="application/pdf">
								</td>
								<td valign='top'>
									<a href='#' onclick="showPhotos(1);location.reload();" style='color:black;font-size:18px;text-decoration:none;color:black;font-size:18px'>
										<b>X</b>
				...
				else
					{
						?>
							<tr align='center'>
								<td>
									<embed src="/<?=$version?>/doc/<?=$vehicule_id?>/<?=$entry?>" width='840px' height='520px' style="max-width:810px;margin:1em" type="application/pdf">
								</td>
								<td valign='top'>
									<a href='#' onclick="showPhotos(1);location.reload();" style='color:black;font-size:18px;text-decoration:none;color:black;font-size:18px'>
										<b>X</b>
...
<tr class="<?= $tr_classes ?>">
	<td height="45">
		<?= $infos["title"] ?>: &nbsp;
		<button type="button" class="BoutonPhoto hidden aligne-droite" data:field_id="<?= $id ?>" id="<?= $id ?>-bt_photo">
		</button>
	</td>

	<td align="center">
		<label for="photo_<?= $id ?>" class="label-file">
			&nbsp;&nbsp;&nbsp;&nbsp;<img id="Photo_loading_<?= $id ?>" src="/capvo/img/app_photo.png""	height="40px">
		</label>
